            ...
            <div class='col-xs-12'>
              <div class='box'>
                <div class='box-header'>
                  <h3 class='box-title'>".  strtoupper($table_name)." LIST</h3><div class='pull-right'>
				  <?php echo anchor('".$c_url."/create/','<i class=\"fa fa-plus\"></i> Create',array('class'=>'btn btn-default btn-sm'));?>";
if ($export_excel == '1') {
...
$export_pdf=1;
if ($export_pdf == '1') {
    $string .= "\n\t\t<?php echo anchor(site_url('".$c_url."/pdf'), '<i class=\"fa fa-file-pdf-o\"></i> PDF', 'class=\"btn btn-warning btn-sm\"'); ?>";
}
$string .= "</div>
                </div><!-- /.box-header -->
                <div class='box-body'>
...
$string .= "\n\t\t    <td style=\"text-align:center\" width=\"140px\">"
        . "\n\t\t\t<?php "
        . "\n\t\t\techo anchor(site_url('".$c_url."/read/'.$".$c_url."->".$pk."),'<i class=\"fa fa-eye\"></i>',array('title'=>'detail','class'=>'btn btn-primary btn-sm')); "
        . "\n\t\t\techo '  '; "
