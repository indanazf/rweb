<div class="join-us">
	...
	<div class="join-us__banner">
		<div class="banner-overlay wow animated fadeIn" style="height:80%">
      		<img src="<?= base_url('uploads/'.$row->IMG) ?>" style="margin-left:-435px;margin-top:-100px;">
    	</div>
    	<div class="join-us__banner__title wow animated fadeIn" data-wow-delay="0.5s"><!-- <?=$row->SUBJECT?> --></div>
	</div>
	<?php }?>
	<div class="container">
		<div class="join-us__content-1" style="margin-top:-80px">
			<div class="row">
				<div class="col-md-4">
