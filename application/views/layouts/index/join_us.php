		...
		<div class="join-us__content-1">
			<div class="row">
				<div class="col-md-4">
					...
					<div class="join-us__content-1__title  wow animated fadeIn">Career with Us</div>
					<div class="join-us__content-1__desc wow animated fadeIn" data-wow-delay="1s">We build best experience for our community as a team</div>
				</div>
				<div class="col-md-4">
				...
				<div class="col-md-4">
					...
					<div class="join-us__content-1__title wow animated fadeIn">Become a Partner</div>
					<div class="join-us__content-1__desc wow animated fadeIn" data-wow-delay="1s">We build best experience for our community as a team</div>
				</div>
			</div>
		</div>
