            ...
            <div class='col-xs-12'>
              <div class='box'>
                <div class='box-header'>
				  ...
				  <?php echo anchor('content_image/create/','<i class="fa fa-plus"></i> Create',array('class'=>'btn btn-default btn-sm'));?>
	    ...
	    <tbody>
			...
			echo '  '; 
			echo anchor(site_url('content_image/update/'.$content_image->ID_IMAGE),'<i class="fa fa-pencil-square-o"></i>',array('title'=>'edit','class'=>'btn btn-warning btn-sm')); 
			echo '  '; 
			echo anchor(site_url('content_image/delete/'.$content_image->ID_IMAGE),'<i class="fa fa-trash-o"></i>','title="delete" class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
			?>
		    </td>
	        </tr>
                <?php
