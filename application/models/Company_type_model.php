...
class Company_type_model extends CI_Model
{
    ...
    function total_rows($q = NULL) {
        $this->db->like('id_company_type', $q);
	$this->db->or_like('company_type', $q);
...
/* End of file Company_type_model.php */
/* Location: ./application/models/Company_type_model.php */
